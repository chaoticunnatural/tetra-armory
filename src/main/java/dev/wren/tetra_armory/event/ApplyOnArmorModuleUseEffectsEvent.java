...
public class ApplyOnArmorModuleUseEffectsEvent extends Event {
    ...
    public ApplyOnArmorModuleUseEffectsEvent(LivingEntity usingEntity, ItemStack itemStack, double multiplier) {
