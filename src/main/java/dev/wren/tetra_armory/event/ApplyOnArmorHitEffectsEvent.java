package dev.wren.tetra_armory.event;

import net.minecraft.world.entity.LivingEntity;
import net.minecraft.world.item.ItemStack;
import net.minecraftforge.eventbus.api.Event;

public class ApplyOnArmorHitEffectsEvent extends Event {
    private LivingEntity wearerEntity;
    ...
    public ApplyOnArmorHitEffectsEvent(LivingEntity wearerEntity, LivingEntity attackingEntity, ItemStack itemStack, double multiplier) {
        this.wearerEntity = wearerEntity;
    ...
    public LivingEntity getWearerEntity() {
        return this.wearerEntity;
    }
